...
public class WindowOperator<K, IN, ACC, OUT, W extends Window>
    ...
    public void processElement(StreamRecord<IN> element) throws Exception {
        System.out.println("@@@@@  window operator 的 processElement 开始....");
        System.out.println("窗口收到数据  :  " + element.getValue());
        ...
        if (windowAssigner instanceof MergingWindowAssigner) {
            System.out.println("这是一个 merging window assigner 。。。");
            ...
            for (W window : elementWindows) {
                ...
                System.out.println("窗口内  onElement 判断, triggerResult: " + triggerResult.name());
                ...
                if (triggerResult.isFire()) {
                    ...
                    System.out.println("trigger fire ！ 准备触发窗口");
            ...
            //System.out.println(" 这不是一个 merging window assigner .....");
            for (W window : elementWindows) {
                ...
                TriggerResult triggerResult = triggerContext.onElement(element);
                System.out.println(" on element 判断的结果是： " + triggerResult.name());
                ...
                if (triggerResult.isFire()) {
                    ...
                    System.out.println("on element 判断要 fire，准备触发窗口");
        ...
        System.out.println("@@@@@  window operator 的 processElement 完毕....");
    }

    @Override
    public void onEventTime(InternalTimer<K, W> timer) throws Exception {
        System.out.println("^^^^^^ windowOperator 的 on event time 开始调用");
        ...
        System.out.println("^^^^^^ windowOperator 的 on event time 调用完毕");
    }
