...
public abstract class AbstractStreamOperator<OUT>
    ...
    public void processWatermark(Watermark mark) throws Exception {
        //System.out.println("***** AbstractStreamOperator 算子，processWatermark开始调用 ,线程号："+ Thread.currentThread().getId());
        if (timeServiceManager != null) {
            //System.out.println("推进watermark为：" + mark.getTimestamp());
            timeServiceManager.advanceWatermark(mark);
        }
        /*for (StackTraceElement stackTraceElement : Thread.currentThread().getStackTrace()) {
            System.out.println(stackTraceElement);
        }*/
        //System.out.println("----- 准备输出一个watermark : " + mark.getTimestamp());
        output.emitWatermark(mark);
        //System.out.println("***** AbstractStreamOperator 算子，processWatermark调用结束 ,线程号："+ Thread.currentThread().getId());
    }
